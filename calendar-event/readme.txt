...
Donate link: https://total-soft.com/wp-event-calendar
Tags: Calendar, event calendar, wp calendar, event, events,
...
* [Event Calendar Premium](https://total-soft.com/wp-event-calendar)
* [All Calendar Demo Types](https://total-soft.com/event-calendar-classic-1)
...
* [Support Forum](https://wordpress.org/support/plugin/calendar-event)
...
### [Premium version adds](https://total-soft.com/wp-event-calendar/)

* [3 beautiful customizable themes](https://total-soft.com/event-calendar-crazy-1)
* [Crazy Calendar Theme](https://total-soft.com/event-calendar-crazy-2)
* [Schedule Theme](https://total-soft.com/event-calendar-schedule-2/)
* [Full Year Calendar Theme](https://total-soft.com/event-calendar-full-year-1)
...
* If you notice any errors or have any questions with our event calendar, you can notify us. We will investigate and solve the problem. Check out the [Event Calendar Support Forum](https://wordpress.org/support/plugin/calendar-event) on our website. If you don't find a solution to your question here, don't hesitate to [click here to contact us](https://total-soft.com/contact-us/).
...
*  In case of any problems during the installation of the calendar, [please click here to contact us](https://total-soft.com/contact-us/).

== Screenshots ==

1. An example of plugin in action.
2. An example of plugin in action.
3. An example of plugin in action.
4. An example of plugin in action.
5. An example of plugin in action.
6. An example of plugin in action.
7. An example of plugin in action.
8. An example of plugin in action.
9. An example of plugin in action.
10. An example of plugin in action.
11. An example of plugin in action.
12. An example of plugin in action.
13. An example of plugin in action.
14. An example of plugin in action - Crazy Theme.
15. An example of plugin in action - Schedule Theme
...
* Fixed a bug with description. The problem was with the symbols.

= Version 1.5.7 =

* All bugs with PHP 8 have been fixed.

= Version 1.5.6 =

* Added function for event copy.
* Calendar has been tested up to version 6.3.

= Version 1.5.4 =

* Fixed bug. The calendar in the themes shown above the menu.

= Version 1.5.3 =

* Page and widget calendar conflict issue.

= Version 1.5.2 =

* Fixed a bug with another plugin. With the YOAST plugin gave a problem and the calendar did not work correctly.

= Version 1.5.1 =

* Problem solved. The plugin did not work with TS Poll. The poll didn't show up on the calendar.
* Fixed bug with events. Youtube video didn't work properly.

= Version 1.5.0 =

* Fixed a bug with the calendar.


= Version 1.4.9 =

* Fixed PHP sprintf function issue
